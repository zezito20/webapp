...
namespace burguerwebapp.Migrations
{
    ...
    [Migration("20200416122856_addedorder")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("burguerwebapp.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("burguerwebapp.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("burguerwebapp.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("burguerwebapp.Models.OrderDetail", b =>
                {
                    b.HasOne("burguerwebapp.Models.Burguer", "Burguer")
                        .WithMany()
                        .HasForeignKey("BurguerId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("burguerwebapp.Models.Order", "Order")
